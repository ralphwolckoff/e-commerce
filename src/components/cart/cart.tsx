...
export default function CartPage() {
  ...
  if (items.length === 0) {
    return (
      <div className="text-center py-10">
        ...
        <a
          href="/products"
          className="text-lg text-center font-bold text-primary-800 hover:underline"
        >
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      <Typography variant="lead" component="h1" className="font-bold mb-6">
        Mon Panier
      </Typography>
      ...
      <div className="flex flex-col md:flex-row justify-between gap-8 mt-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md w-full md:w-1/2">
          <Typography variant="lead" component="h1" className="font-bold mb-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center py-2 border-b border-gray-100">
              ...
              >{totalItems} article</Typography>
                ...
                theme="gray"
                className="font-semibold"
              >{totalItems} articles</Typography>
              )}
            </div>
...
export const Modale = ({ show, title, message, onConfirm, onCancel }: ModalProps) => {
  if (!show) return null;
  return (
    <div className="fixed inset-0 bg-gray-600/50 overflow-y-auto h-full w-full flex justify-center items-center z-50">
      <div className="relative p-8 bg-white w-96 rounded-lg shadow-xl">
        ...
        <Typography variant="caption3" component="p" theme="gray">
          {message}
        </Typography>
