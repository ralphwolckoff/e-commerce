...
const Newsletter = () => {
  return (
    <section className="overflow-hidden pb-10">
      <div className="max-w-[1370px] mx-auto px-4 sm:px-8 xl:px-0">
              ...
              <form>
                <div className="flex flex-col sm:flex-row gap-4">
                  <input
                    ...
                    className="w-full bg-gray-100 border border-gray-3 outline-none rounded-md placeholder:text-dark-4 py-3 px-5"
                  />
                  <button
                    type="submit"
                    className="inline-flex justify-center py-3 px-7 text-white bg-blue-800 font-medium rounded-md ease-out duration-200 hover:bg-blue-700"
                  >
                    Subscribe
                  </button>
                </div>
