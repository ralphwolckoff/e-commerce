...
const ProductModal = ({ isOpen, onClose, productId }: PageProps) => {
  ...
  if (!product) {
    return <div className="text-center py-12">Produit introuvable.</div>;
  }

  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Detail product">
      <div className="flex items-center justify-center ">
        <div className="w-full max-w-[1100px] rounded-xl shadow-3 bg-white p-7.5 relative modal-content">
          <div className="flex items-center  gap-4.5 sm:flex-col">
            <div className="max-w-[526px] w-full">
              <div className="flex  lg:gap-4 gap-5 ">
                <div className="relative z-1 overflow-hidden flex items-center justify-center w-full sm:min-h-[400px] bg-gray-1 rounded-lg border border-gray-3">
                  <div>
                    <button
                      ...
                      className="gallery__Image w-10 h-10 rounded-[5px] text-primary  cursor-pointer shadow-1 flex items-center justify-center ease-out duration-200 text-dark hover:text-blue absolute top-4 lg:top-8 right-4 lg:right-8 z-50"
                    >
                      <svg
                  ...
                  {product.images &&
                    product.images.map((img, key) => (
                      <button
                        ...
                        key={key}
                        className={`flex items-center justify-center w-20 h-20 overflow-hidden rounded-lg bg-gray-1 cursor-pointer ease-out duration-200 hover:border-2 hover:border-blue-500 ${
            ...
            <div className="max-w-[445px] w-full">
              <div className="flex items-center gap-10 mb-4">
                <Typography variant="lead" component="h3" className="font-blod">
                  Boutique :
                </Typography>
