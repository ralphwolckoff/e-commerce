        ...
        <div className="text-center">
          {allProducts.length < 2 ? (
            <Typography variant="lead" component="h3" className="mb-6">
              {allProducts.length} element trouvé
            </Typography>
          ) : (
            <Typography variant="lead" component="h3" className="mb-6">
              {allProducts.length} elements trouvés
            </Typography>
          )}
        </div>
        <div className="px-4">
          <div className="flex flex-col sm:flex-row justify-between items-center bg-white rounded-lg shadow-md mb-6 space-y-4 sm:space-y-0">
            <input
              type="text"
